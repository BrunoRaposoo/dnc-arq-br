    ...
    <div className="container">
      <div className="text-section d-flex">
        ...
        <div className="text-section-text">
          ...
          <p className='secondary-color'>{appContext.languages[appContext.language].about.p2}</p>
          <p className='secondary-color'>{appContext.languages[appContext.language].about.p3}</p>
        </div>
      </div>
    </div>
  )
